...
public class CustomerReviewTest {
    ...
    @Test
    void testWrirteNewReview(FxRobot robot) {
        //robot.clickOn("#timerButton");
        //  robot.clickOn("#BackToCustomer");


        robot.clickOn("#goReview");
        //robot.clickOn("#backToCustomerMain");

        //se deschide ReviewN

        robot.clickOn("#opinion");
        robot.write("Complimente bucatarului!!");

        robot.clickOn("#check");
        robot.write("user2");
        robot.clickOn("#checkUs");

        ///o sa apara un Alert Box
        robot.clickOn("OK");
